...
var ImageMIMETypeMap = MIMETypeMap{
	EXTENSION_BMP:  IMAGE_BMP,
	EXTENSION_GIF:  IMAGE_GIF,
	EXTENSION_ICO:  IMAGE_ICO,
	EXTENSION_JPEG: IMAGE_JPEG,
	EXTENSION_JPG:  IMAGE_JPG,
	EXTENSION_PNG:  IMAGE_PNG,
	EXTENSION_SVG:  IMAGE_SVG,
	EXTENSION_TIFF: IMAGE_TIFF,
	EXTENSION_WEBP: IMAGE_WEBP,
}
